...
//   return (
//     <section id="home" className="mt-4 card rounded-[20px] p-4 sm:p-8 flex justify-between border border-gray-700">
...
const education = [
  {
    degree: 'Master of Science in Computer Software Developering',
    school: 'San Jose State University, CA, USA',
    gpa: '3.8/4.0',
    year: 'August 2023 - May 2025',
  },
  {
    degree: 'Bachelor of Science in Computer Science and Developering',
